...
class App extends Component {
    ...
    setupEventListeners = async () =>  {
        ...
        /*crowdfunding.events.InvestmentMade({}, () => {
            this.fetchLiveCampaigns();
        });
    ...
    createCampaign = async () => {
        ...
        try {
            ...
            await crowdfunding.methods.createCampaign(
                title,
                web3.utils.toWei(pledgeCost, 'ether'), // Convert to Wei
                pledgesNeeded
            ).send({
                from: accounts[0],
            ...
            const collectedFees = web3.utils.fromWei(
                await crowdfunding.methods.getContractFees().call(),
                'ether'
            );
    ...
    pledge = async (campaignId, pledgeCost) => {
        ...
        try {
            ...
            this.fetchLiveCampaigns();
            this.fetchBalance(); // Refresh contract balance
        } catch (error) {
    ...
    cancelCampaign = async (campaignId) => {
        ...
        try {
            ...
            this.fetchLiveCampaigns();
            this.fetchCanceledCampaigns();
            this.fetchBannedEntrepreneurs(); // Fetch banned entrepreneurs
        } catch (error) {
            console.error(error);
    ...
    fulfillCampaign = async (campaignId) => {
        ...
        try {
            ...
            this.fetchLiveCampaigns(); // Refresh live campaigns
            this.fetchCompletedCampaigns(); // Refresh completed campaigns
            await this.fetchBalance(); // Refresh the balance and fees at the top of the page
        } catch (error) {
    ...
    withdrawFunds = async () => {
        ...
        try {
            ...
            this.fetchBalance(); // Refresh balance and collected fees
        } catch (error) {
    ...
    claimRefund = async () => {
        ...
        try {
            ...
            // Refresh the canceled campaigns and balance after the refund
